...
% data = createImmanentDataset(100,20)
testImmanenceTrans(data)

%% Function to test for Immanence according to Prof's theory

function immanence = testImmanenceTrans(dataset)
%% Initialisation
...
uniqueDataset = uniqueStructTrans(dataset);
