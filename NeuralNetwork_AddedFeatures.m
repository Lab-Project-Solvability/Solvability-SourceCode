...
data1 = table2struct(readtable('transcendentDataset-AddedFeatures.xlsx'));
 
x1 = [data1.length; data1.width; data1.height; data1.x_axis; data1.y_axis; data1.z_axis];
...
xlswrite('transcendentDataset-AddedFeatures.xlsx',y', 1 , 'J2')
...
% Uncomment these lines to save a new NN
 trainedNet_addedF = net; 
 save trainedNet_addedF;
